...
class GUI:
    ...
    UI_SCALE_FACTOR = 0.6
    UI_IMG_ROOT = "resources/UI_Icons"
    ...
    def clear_color(self) -> None:
        ...
        """
        self.screen.fill((0, 0, 0))  # fully transparent
    ...
    def __draw_button_cluster(self, x, y):
        ...
        buttons = [
            {'pos': (x, y - button_spacing), 'label': 'Y'},  # UP
            {'pos': (x - button_spacing, y), 'label': 'X'},  # LEFT
            {'pos': (x + button_spacing, y), 'label': 'B'},  # RIGHT
            {'pos': (x, y + button_spacing), 'label': 'A'},  # DOWN
        ]
