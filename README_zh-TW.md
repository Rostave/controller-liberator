...
- _**請使用 Python<=3.12 執行該應用程式**，因為 mediapipe 尚不支援 Python 3.13！_

- _安裝 Python 函式庫 vgamepad 時，將會彈出視窗要求安裝虛擬遊戲手把驅動。請點擊安裝。_
...
- 需要 `pyobjc-framework-Cocoa` 以支援視窗管理（已包含在 requirements.txt 中）
